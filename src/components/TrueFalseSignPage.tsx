...
import TrueFalseSignResultPage from './TrueFalseSignResultPage';
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            localStorage.setItem('userTrueFalseSignValues',chooseValues.toString());
  ...
  return (
    <>
      <IonHeader>
        ...
        <IonTitle>
          <IonIcon icon={checkmarkDoneCircle} />&nbsp;&nbsp;True/False Sign
        </IonTitle>
        </IonToolbar>
      </IonHeader>
