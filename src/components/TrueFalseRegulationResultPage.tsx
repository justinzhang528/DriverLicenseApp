...
function TrueFalseRegulationResultPage() {
    const [dataCounts] = useState(signImg.dataCounts);
    const [problems] = useState(JSON.parse(localStorage.getItem('trueFalseRegulationProblems') || '{}'));
    const [chooseValues] = useState((localStorage.getItem('userTrueFalseRegulationValues')  || '{}').split(','));
...
export default TrueFalseRegulationResultPage;